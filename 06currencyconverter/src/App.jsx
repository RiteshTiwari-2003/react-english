        ...
        <form onSubmit={(e)=>{
          ...
          <div className="w-full mb-1">
            ...
            <div className="relative w-full h-0.5">
              ...
              -translate-y-1/2 border-2 border-white rounded-md bg-blue-600 text-white px-2 py-0.5" onClick={swap}>Swap</button></div>
              <div className='w-full mb-1'>
              <InputBox
              label="to"
              ...
              selectedCurrency={to}
            /></div>
            <button type="submit" className='w-full bg-blue-600 text-white px-4 py-3 rounded-lg'>Convert {from} to {to}</button></form></div>
      </div>
    </div>
  )
}
